...
Si = materials.Silicon(thickness=10, nd=1E15)  # Si constructor handles everything we want by default. required parameter is thickness
stp = environment()  # default constructor, V=0, T=293 K, B=0, E=0, no light source
resistor = device.Device(material_list=[Si], interfaces=None, contacts=None, R_series=1, environment=stp)
